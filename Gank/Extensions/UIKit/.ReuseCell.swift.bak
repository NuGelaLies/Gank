...
extension UITableView {
    ...
    public func registerNib<T: UITableViewHeaderFooterView>(headerFooterViewClass name: T.Type) {
    ...
    ///
    /// - Parameter name: UITableViewHeaderFooterView type
    public func register<T: UITableViewHeaderFooterView>(headerFooterViewClass name: T.Type) {
