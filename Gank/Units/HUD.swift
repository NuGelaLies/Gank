...
final class HUD {
    ...
    class func showSuccess(_ text: String, duration: TimeInterval = 2.5, completionBlock: ActionHander? = nil) {
        showText(text, messageType: .success, duration: duration, completionBlock: completionBlock)
    }

    class func showInfo(_ text: String, duration: TimeInterval = 2.5, completionBlock: ActionHander? = nil) {
        showText(text, messageType: .info, duration: duration, completionBlock: completionBlock)
    }
    
    class func showError(_ text: String, duration: TimeInterval = 2.5, completionBlock: ActionHander? = nil) {
        showText(text, messageType: .error, duration: duration, completionBlock: completionBlock)
    }

    class func showError(_ error: Error, duration: TimeInterval = 2.5, completionBlock: ActionHander? = nil) {
        showText(error.localizedDescription, messageType: .error, duration: duration, completionBlock: completionBlock)
    }

    class func showWarning(_ text: String, duration: TimeInterval = 2.5, completionBlock: ActionHander? = nil) {
        showText(text, messageType: .warning, duration: duration, completionBlock: completionBlock)
    }

    private class func showText(_ text: String, messageType: MessageType, duration: TimeInterval = 2, completionBlock: ActionHander? = nil) {
